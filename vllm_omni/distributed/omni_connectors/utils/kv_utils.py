...
def kv_zmq_port(
    ...
    host.  Each stage replica also gets a disjoint port range so multiple
    sender replicas of the same logical stage can coexist on one host.
    The formula is backward-compatible for replica 0 rank 0.
    """
    return (
        base_port
